...
const Footer = () => (
  <div
    className='absolute z-[1000] bottom-0 left-0 flex justify-between items-center w-screen h-10 px-3 bg-zinc-800 text-white text-xs md:text-base'
  >
    ...
    <a className='font-semibold hover:underline' href='https://diragb.dev/blog/bosdac' target='_blank'>
      Read More
    </a>
  </div>
)
