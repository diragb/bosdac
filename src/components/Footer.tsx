...
// Functions:
const Footer = () => (
  <div className='absolute z-10 bottom-0 left-0 flex justify-between items-center w-screen h-10 px-3 bg-zinc-800 text-white text-xs md:text-base'>
    <div className='flex justify-center items-center gap-2.5'>
      <div>Images from <a className='font-semibold hover:underline' href='https://mosdac.gov.in/live/index_one.php?url_name=india' target='_blank'>MOSDAC Live</a> @ ISRO</div>
